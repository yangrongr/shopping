<template>
	<div>
		...
		<!-- 购物车商品 -->
		<van-cell title="商城" icon="shop-o" v-else style="margin-top: -2px;">
			<template>
		...
		<van-checkbox-group v-model="result" ref="checkboxGroup" @change="checkBoxChange()" style="margin-bottom: 100px;">
